...
RESULT_PATH = os.path.join(".", "RESULTS", "3D", "result_" + specifier + ".png")
...
image_lbl_path = os.path.join(DATA_PATH,"lbl.nii.gz")
dict_path = os.path.join(DATA_PATH, "dict.pickle")
