...
for percentage in percentages:
    ...
    mean_result_path = os.path.join(percentage_path, "global_mean_result_edt.csv")
    std_result_path = os.path.join(percentage_path, "global_std_result_edt.csv")
    ...
    for iteration in iterations:
        ...
        if os.path.isdir(os.path.join(iteration_path, "results", "edt")):
            ...
            for patient in patients:
                ...
                # On lit le fichier
                df_path = os.path.join(iteration_path, "results", "edt", patient, "result.csv")
